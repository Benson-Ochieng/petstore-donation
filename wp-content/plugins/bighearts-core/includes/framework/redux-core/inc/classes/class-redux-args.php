	...
	class Redux_Args {
		...
		public function __construct( $parent, array $args ) {
			...
			$default = array(
				...
				'font_weights'                     => array(
                    [ 'id' => '100', 'name' => __( 'Thin 100', 'bighearts-core' )],
                    [ 'id' => '200', 'name' => __( 'ExtraLight 200', 'bighearts-core' )],
                    [ 'id' => '300', 'name' => __( 'Light 300', 'bighearts-core' )],
                    [ 'id' => '400', 'name' => __( 'Regular 400', 'bighearts-core' )],
                    [ 'id' => '500', 'name' => __( 'Medium 500', 'bighearts-core' )],
                    [ 'id' => '600', 'name' => __( 'SemiBold 600', 'bighearts-core' )],
                    [ 'id' => '700', 'name' => __( 'Bold 700', 'bighearts-core' )],
                    [ 'id' => '800', 'name' => __( 'ExtraBold 800', 'bighearts-core' )],
                    [ 'id' => '900', 'name' => __( 'Black 900', 'bighearts-core' )],
                    [ 'id' => '100italic', 'name' => __( 'Thin 100 Italic', 'bighearts-core' )],
                    [ 'id' => '200italic', 'name' => __( 'ExtraLight 200 Italic', 'bighearts-core' )],
                    [ 'id' => '300italic', 'name' => __( 'Light 300 Italic', 'bighearts-core' )],
                    [ 'id' => '400italic', 'name' => __( 'Regular 400 Italic', 'bighearts-core' )],
                    [ 'id' => '500italic', 'name' => __( 'Medium 500 Italic', 'bighearts-core' )],
                    [ 'id' => '600italic', 'name' => __( 'SemiBold 600 Italic', 'bighearts-core' )],
                    [ 'id' => '700italic', 'name' => __( 'Bold 700 Italic', 'bighearts-core' )],
                    [ 'id' => '800italic', 'name' => __( 'ExtraBold 800 Italic', 'bighearts-core' )],
                    [ 'id' => '900italic', 'name' => __( 'Black 900 Italic', 'bighearts-core' )],
				),
		...
		private function no_errors_please( array $args ): array {
			...
			if ( empty( $args['footer_credit'] ) ) {
				...
				/* translators: 1: Redux, 2: Link to plugin review */
					__( 'Enjoyed %1$s? Please leave us a %2$s rating. We really appreciate your support!', 'bighearts-core' ),
					'<strong>' . __( 'Redux', 'bighearts-core' ) . '</strong>',
			...
			if ( empty( $args['menu_title'] ) ) {
				$args['menu_title'] = esc_html__( 'Options', 'bighearts-core' );
			}

			if ( empty( $args['page_title'] ) ) {
				$args['page_title'] = esc_html__( 'Options', 'bighearts-core' );
			}
