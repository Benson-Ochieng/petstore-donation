    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'raw' => esc_html__('Note: Left/Right values are reversed for even items.', 'bighearts-core' ),
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => Controls_Manager::DIMENSIONS,
                'description' => esc_html__('Note. Left/Right values are reversed for even items.', 'bighearts-core'),
                'mobile_default' => [
                    'top' => 0,
                    'right' => 0,
                    'bottom' => 0,
